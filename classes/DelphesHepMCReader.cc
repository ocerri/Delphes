  ...
  TObjArray *partonOutputArray)
{
  ...
  //If pdg does not know the particle, try to see if is an RHad
  if(pdgParticle)
  {
    candidate->Charge = int(pdgParticle->Charge()/3.0);
  }
  else if(abs(fPID) == 1000612) candidate->Charge = TMath::Sign(1, fPID);
  else if(abs(fPID) == 1000622) candidate->Charge = 0;
  else if(abs(fPID) == 1000632) candidate->Charge = TMath::Sign(1, fPID);
  else if(abs(fPID) == 1000642) candidate->Charge = 0;
  else if(abs(fPID) == 1000652) candidate->Charge = TMath::Sign(1, fPID);
  else if(abs(fPID) == 1006113) candidate->Charge = 0;
  else if(abs(fPID) == 1006211) candidate->Charge = TMath::Sign(1, fPID);
  else if(abs(fPID) == 1006213) candidate->Charge = TMath::Sign(1, fPID);
  else if(abs(fPID) == 1006223) candidate->Charge = TMath::Sign(2, fPID);
  else if(abs(fPID) == 1006311) candidate->Charge = 0;
  else if(abs(fPID) == 1006313) candidate->Charge = 0;
  else if(abs(fPID) == 1006321) candidate->Charge = TMath::Sign(1, fPID);
  else if(abs(fPID) == 1006323) candidate->Charge = TMath::Sign(1, fPID);
  else if(abs(fPID) == 1006333) candidate->Charge = 0;
  else candidate->Charge = -999;
